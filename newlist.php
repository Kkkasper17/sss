        ...
        <div class="container">
            <div class="header__list-inner">
                ...
                <div class="header__list-button">
                    <form action="../php/addpage.php">
                    <button class="header__button-add header__button"
                       id="add">ADD</button>  
                    </form>
                    <button class="header__button-delete header__button" id=#delete-product-btn onclick="remove('#product__boxes')">
                        MASS DELETE
                    </button>
                </div>
            </div>
